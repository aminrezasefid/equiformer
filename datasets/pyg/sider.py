...
URLS = {
    "precise3d": "https://drive.google.com/uc?export=download&id=1TlafZEWLVKl54oCPbsYXclO4QjAaeJsQ",
    "optimized3d": "https://drive.google.com/uc?export=download&id=1ouG85TVBtOLaUkP6V1hY-UfRmn7mVcBF",
    "rdkit3d": "https://drive.google.com/uc?export=download&id=1qyMsZbgErB8y1UXYn7rDQmFYz9Fl-COF",
    "rdkit2d": "https://drive.google.com/uc?export=download&id=14HpwKJTIOWQFWipMwOGrvERlGCcpxuti"
}
...
class SIDER(InMemoryDataset):
    ...
    def target_names(self) -> List[str]:
        ...
        if hasattr(self, 'labels') and self.labels is not None:
            return [name for name, idx in sider_target_dict.items() 
                   if idx in self.labels]
        return list(sider_target_dict.keys())
    def __init__(
        self,
        root: str,
        ...
        self.labels = (
            [sider_target_dict[label] for label in dataset_args]
            if dataset_args is not None
            else list(sider_target_dict.values())
        )
