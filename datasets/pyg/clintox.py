...
URLS = {
    "precise3d": "https://drive.google.com/uc?export=download&id=1kHdk_PIAuoe0ZH8PDV4AZPVzTDSwolN-",
    "optimized3d": "https://drive.google.com/uc?export=download&id=1aN4PFZdoJk6lXz8JcqSCjjXW4EZO0sS_", ###### CHANGE ######
    "rdkit3d": "https://drive.google.com/uc?export=download&id=12X3CBbhzNzvB3QSnRw4hNUfj_4RgSba0",
    "rdkit2d": "https://drive.google.com/uc?export=download&id=1gpheq-AJjPBf6RSd3AB7oyOq1PjVMg_h"
}
...
class Clintox(InMemoryDataset):
    ...
    def target_names(self) -> List[str]:
        ...
        if hasattr(self, 'labels') and self.labels is not None:
            return [name for name, idx in clintox_target_dict.items() 
                   if idx in self.labels]
        return list(clintox_target_dict.keys())
    def __init__(
        self,
        root: str,
        ...
        self.labels = (
            [clintox_target_dict[label] for label in dataset_args]
            if dataset_args is not None
            else list(clintox_target_dict.values())
        )
