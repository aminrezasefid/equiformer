...
URLS = {
    "precise3d": "https://drive.google.com/uc?export=download&id=1gB5Zwb4xXtQ4gJPWEC97JbWsNIYTib29",
    "optimized3d": "https://drive.google.com/uc?export=download&id=1ZYq1Mp6Svh1Mn5Xq_4Ppky3KrCNjfEkl",  ###### CHANGE ######
    "rdkit3d": "https://drive.google.com/uc?export=download&id=1xFkLFHbUjkPUHbeua9n0ZRmSZcpsHVLd",
    "rdkit2d": "https://drive.google.com/uc?export=download&id=1GJoO1iyTkd17yR7Zi111E9m3qf096Goz",
}
...
class MUV(InMemoryDataset):
    ...
    def target_names(self) -> List[str]:
        ...
        if hasattr(self, 'labels') and self.labels is not None:
            return [name for name, idx in muv_target_dict.items() 
                   if idx in self.labels]
        return list(muv_target_dict.keys())
    def __init__(
        self,
        root: str,
