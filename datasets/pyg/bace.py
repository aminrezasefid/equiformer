...
URLS = {
    "precise3d": "https://drive.google.com/uc?export=download&id=1_iigUd5JTCn-ed5QaAxjeot_N0KxB9XJ",
    "optimized3d": "https://drive.google.com/uc?export=download&id=1PO7zobV-n4TTVFra4lRa3La9Lpq1tC2w", ###### CHANGE ######
    "rdkit3d": "https://drive.google.com/uc?export=download&id=10ycwVE8fgOQiP4wEHwiB4ItSbOzeb87p",
    "rdkit2d": "https://drive.google.com/uc?export=download&id=1wulaTln6q-NFJnDhLkZj_EIHYd9kjWsV"
}
...
class Bace(InMemoryDataset):
    ...
    def target_names(self) -> List[str]:
        ...
        if hasattr(self, 'labels') and self.labels is not None:
            return [name for name, idx in bace_target_dict.items() 
                   if idx in self.labels]
        return list(bace_target_dict.keys())
    def __init__(
        self,
        root: str,
        ...
        self.labels = (
            [bace_target_dict[label] for label in dataset_args]
            if dataset_args is not None
            else list(bace_target_dict.values())
        )
